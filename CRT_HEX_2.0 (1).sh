...
show_help() {
    ...
    echo -e "${GREEN}│${RESET}  ${AMBER}USAGE:${RESET} ./CRT_HEX-V2.0.sh -d <domain> [options]     ${GREEN}│${RESET}"
...
clear
echo -e "${GREEN}═══════════════════════════════════════════════════════════════════${RESET}"
echo -e "${AMBER}   🔐 CRT_HEX v2.0 - Target: ${BOLD}${WHITE}$DOMAIN${RESET}${AMBER} [GitHub: hex-3030]${RESET}"
echo -e "${GREEN}═══════════════════════════════════════════════════════════════════${RESET}\n"
